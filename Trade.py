...
def TotProfit(xapka, Ticker):
    ...
    def ToSell(i, xtred):
        ...
        if  (xmacd == 4 or  (OscSum<=-1 and xmacd <0) )  and Prebuy == 10 :
            return Prebuy
        elif OscSum == 0 and Prebuy == 11 :
            return Prebuy
...
#---------------------------------------------------------------------------
    ...
    for i in range(5,len(xapka)):
        ...
        if toBuy >= 1 :
            ...
            a = [Ticker, xapka.at[i-1,"buy"], Buydate, xapka.at[i, "date"], buyPrice, xapka.at[i,"close"], xapka.at[i,"profit"]]
