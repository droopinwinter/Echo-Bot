...
def GetEvaluate_TW(befDay,StrDate):
    msg5 = read_sql(cmd.Sig2TrendAndOsc_part1(befDay,'TW'), db.eng_apka)
    if msg5 !='':
        msg5 = "\n日期 : "+ StrDate +"\n_股指_前22個\n"+msg5
    msg6 = read_sql(cmd.Sig2TrendAndOsc_part2(befDay,'TW'), db.eng_apka)
    if msg6 !='':
        msg6 = "_ETF_共22個\n"+msg6  
    msg7 = read_sql(cmd.Sig2TrendAndOsc_part3(befDay,'TW'), db.eng_apka)
    if msg7 !='':
        msg7 = "_n其他_共11個\n"+msg7
    return msg5 + msg6 + msg7
##########################################################################
def GetEvaluate_US(befDay,StrDate):
    msg5 = read_sql(cmd.Sig2TrendAndOsc_part1(befDay,'US'), db.eng_apka)
    if msg5 !='':
        msg5 = "\n日期 : "+ StrDate +"_股指_＆板塊_前22個\n"+msg5

    msg6 = read_sql(cmd.Sig2TrendAndOsc_part2(befDay,'US'), db.eng_apka)
    if msg6 !='':
        msg6 = "_大科技_共11個\n"+msg6
    return msg5 + msg6
